...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventSlot.ml'
        db.add_column(u'base_eventslot', 'ml',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['django_mailman.List']),
                      keep_default=False)
    ...
    models = {
        ...
        u'base.eventslot': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ml': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['django_mailman.List']"}),
